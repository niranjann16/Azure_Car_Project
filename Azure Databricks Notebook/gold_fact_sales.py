...
df_fact = df_silver.join(df_branch, df_silver.Branch_ID == df_branch.Branch_ID, 'left')\
                   ...
                   .select(df_silver['Revenue'], df_silver['Units_Sold'], df_silver['RevPerUnit'], df_branch. 
                    dim_branch_key, df_dealer.dim_dealer_key, df_date.dim_date_key, df_model.dim_model_key)
...
if spark.catalog.tableExists("cars_catalog.gold.fact_sales"):
    ...
    df_fact.write.format("delta")\
                 .mode("overwrite")\
                 .option("path","abfss://gold@carsdatalake.dfs.core.windows.net/fact_sales")\
